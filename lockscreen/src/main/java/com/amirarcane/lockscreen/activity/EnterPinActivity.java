...
public class EnterPinActivity extends AppCompatActivity {
    ...
    public static  int RESULT_SHARED = 33;
    ...
    private void setPin(String pin) {
        if (mFirstPin.equals("")) {
            ...
            mPreferences.edit().putBoolean(RESULTSETTEDSCUCCESS, false).commit();
            ...
            if (pin.equals(mFirstPin)) {
                ...
                mPreferences.edit().putBoolean(RESULTSETTEDSCUCCESS, true).commit();
                setResult(RESULT_OK);
                 finish();
